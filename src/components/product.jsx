    ...
    return (
        <div className="flex flex-col items-center h-[100%] md:h-[100%] lg:h-[100%] p-10  bg-[linear-gradient(to_bottom,#1A5F99_-50%,#011C6B_150%)]">
            ...
            <div className="flex flex-col gap-10  lg:flex-row">
                ...
                <div className="card ">
                    <h1 className="text-center text-blue-900 font-bold text-2xl pt-5">Dispositivos eletrônicos</h1>
                    <p className="">O Desenvolvimento de Dispositivos Eletrônicos abrange a criação de sistemas embarcados, que são combinações de hardware e software incorporados em produtos.Estes podem ser desde dispositivos vestíveis, como smartwatches, até sistemas de controle industrial, como controladores de máquinas e equipamentos, envolvendo o projeto, prototipagem e implementação de soluções eletrônicas.</p>
                </div>
                <div className="card ">
                <h1 className="text-center text-blue-900 font-bold text-2xl pt-5">Melhora de Eficiência de Maquinário</h1>
