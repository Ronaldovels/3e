...
export default function hero() {
    ...
    return (
        ...
        <div className="relative h-[405px] bg-black z-5">
            {/* Background com blur */}
            <div className="absolute inset-0 bg-[url('/f.jpg')] bg-cover bg-center  opacity-35"></div>

            {/* Conteúdo nítido por cima */}
            <div className="relative z-10 flex flex-row h-full">
                <div className="flex flex-col gap-5 pl-5 pt-10">
                    <h1 className='max-sm:text-5xl text-7xl font-extrabold text-white lg:w-[90%] xl:w-[100%]'>
                    ...
                    <button className=" w-50 h-10 rounded-full bg-[var(--royal-blue)] text-white hover:scale-110 duration-300 ease-in-out font-bold  active:scale-110 "><a href="/Contato">FALE CONOSCO</a></button>
                </div>
            </div>
        </div>
    )
