    ...
    return (
        <div className="flex flex-row h-[405px]">
            <div className="flex flex-col gap-5 pl-5 pt-10">
                <h1 className='max-sm:text-5xl text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#94C3E9] to-[#1A5F99] lg:w-[90%] xl:w-[100%]'>CONCRETIZE SUA IDEIA COM A 3E!</h1>
